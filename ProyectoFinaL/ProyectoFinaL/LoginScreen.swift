...
var emails = ["LaChida","Copilco3nyoyer","CapitolioEnYamas","Probando123"]
var passwords = ["123","2","3","4"]
class LoginScreen: UIViewController {
    ...
    private let profileImageView: UIImageView = {
       ...
       // textFieldContent(emailTextField)
        ...
        if(emailTextField.text == emails[0] && passwordTextField.text == passwords[0]){
            let storyboard = UIStoryboard.init(name: "Main", bundle: nil)
            let second = storyboard.instantiateViewController(withIdentifier: "ordenar") as! ViewController3
            
            show(second, sender: self)
